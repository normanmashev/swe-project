...
| Get all room types for specific hotel | `/api/roomtype/get/all/{id}`  Example: `/api/roomtype/get/all/4` | int id - hotel_id | `GET` | List of all Room_Type or throws if no such hotel with hotel id |
